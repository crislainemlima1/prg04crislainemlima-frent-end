    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <div>
        ...
        <p style={{ fontSize: 13, color: 'var(--ff-muted)' }}>
          Foco total. 25 minutos por sessão, 5 minutos de pausa.
        </p>
      </div>
        ...
        <div style={{ background: 'var(--ff-surface)', border: '1px solid var(--ff-border)', borderRadius: 12, padding: '40px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 24 }}>
          ...
          <div style={{ display: 'flex', gap: 4, background: 'rgba(255,255,255,0.04)', borderRadius: 8, padding: 4, width: '100%', maxWidth: 320 }}>
            {['foco', 'pausa'].map((m) => (
              <button
                ...
                style={{
                  flex: 1, padding: 7, fontSize: 12.5, borderRadius: 6,
                  cursor: 'pointer', border: 'none', fontFamily: 'DM Sans, sans-serif',
                  background: modo === m ? 'var(--ff-surface)' : 'transparent',
                  color: modo === m ? 'var(--ff-text)' : 'var(--ff-muted)',
          ...
          <div style={{ position: 'relative', width: 180, height: 180 }}>
            <svg viewBox="0 0 180 180" style={{ transform: 'rotate(-90deg)', width: 180, height: 180 }}>
              ...
              <circle
                cx="90" cy="90" r={RAIO} fill="none"
                stroke={corAnel} strokeWidth="8" strokeLinecap="round"
          ...
          <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
            ...
            <button
              ...
              style={{ background: 'var(--ff-accent)', color: 'white', border: 'none', borderRadius: 8, padding: '10px 28px', fontFamily: 'Syne, sans-serif', fontSize: 14, fontWeight: 600, cursor: 'pointer' }}
            >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div style={{ background: 'var(--ff-surface)', border: '1px solid var(--ff-border)', borderRadius: 12, padding: 20 }}>
            ...
            <select
              ...
              style={{ width: '100%', background: 'rgba(255,255,255,0.04)', border: '1px solid var(--ff-border)', borderRadius: 8, padding: '9px 12px', color: 'var(--ff-text)', fontFamily: 'DM Sans, sans-serif', fontSize: 13, outline: 'none', marginBottom: 16 }}
            >
            ...
            <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 22, fontWeight: 700, color: 'var(--ff-green)' }}>
              {horasFocoHoje}h {minRestantes}min
            </div>
          ...
          <div style={{ background: 'linear-gradient(135deg, rgba(83,52,131,0.2), rgba(233,69,96,0.1))', border: '1px solid rgba(83,52,131,0.4)', borderRadius: 12, padding: 16 }}>
            ...
            <p style={{ fontSize: 12.5, lineHeight: 1.6, color: 'var(--ff-text)', margin: 0 }}>
              {materiaSelecionada
                ? `Você está estudando ${materiaSelecionada.nome}. Mantenha o foco e revise os pontos mais difíceis!`
                : 'Selecione uma matéria para começar sua sessão de estudos.'}
            </p>
          </div>
          ...
          <div style={{ background: 'var(--ff-surface)', border: '1px solid var(--ff-border)', borderRadius: 12, padding: 20 }}>
            ...
            {sessoesHoje.length === 0 && (
              <p style={{ fontSize: 13, color: 'var(--ff-muted)' }}>Nenhuma sessão hoje ainda.</p>
            )}
